...
<h3>
	책 이미지1 : <%=path+"/"+book_image1 %><br>
	<img src="../bookImg/<%=book_image1 %>">
</h3>
<h3>
	책 이미지2 : <%=path+"/"+book_image2 %><br>
	<img src="../bookImg/<%=book_image2 %>">
</h3>
<h3>
	책 내용 : <%=book_content %>
</h3>
<h3>
	책 가격 : <del><%=book_price %></del> <%=book_price*(100-book_discount)/100 %>
</h3>
<h3>
	할인율 : <%=book_discount %>
</h3>
<a href="bookList.jsp">책 전체 리스트</a><br>
<a href="bookList2.jsp">책 리스트(1page)</a>
</body>
</html>