...
SELECT ENAME, SAL FROM EMP WHERE ENAME BETWEEN 'C' AND 'Q' AND ENAME^='Q' ORDER BY SAL;
...
SELECT * FROM EMP WHERE JOB IN('CLERK','ANLYST') AND SAL NOT IN(1000,3000,5000);
...
SELECT EMPNO, ENAME, JOB, SAL FROM EMP ORDER BY SAL DESC, HIREDATE; 
